...
var Create_user string = "INSERT INTO `users` (`ID`, `Username`, `Password`, `APIkey`, `MFA`, `MFAenabled`, `MFAnew`, `NewUser`, `Admin`, `Reseller`, `Banned`, `Vip`, `MaxTime`, `Cooldown`, `Concurrents`, `MaxSessions`, `PowerSavingExempt`, `BypassBlacklist`, `PlanExpiry`) VALUES" +
	"(NULL, '<<$username>>', '<<$password>>', '', 1, 0, 0, 1, 1, 1, 0, 1, 1200, 30, 4, 5, 1, 1, <<$planexpiry>>);"
